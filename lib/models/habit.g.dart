...
void _habitSerialize(
  ...
  writer.writeDateTimeList(offsets[0], object.daysCompleted);
...
Habit _habitDeserialize(
  ...
  final object = Habit();
  object.daysCompleted = reader.readDateTimeList(offsets[0]) ?? [];
  object.id = id;
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysCompletedElementEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysCompletedElementBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysCompletedLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysCompletedIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'daysCompleted',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysCompletedIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'daysCompleted',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysCompletedLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysCompletedLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  QueryBuilder<Habit, Habit, QDistinct> distinctByDaysCompleted() {
    return QueryBuilder.apply(this, (query) {
